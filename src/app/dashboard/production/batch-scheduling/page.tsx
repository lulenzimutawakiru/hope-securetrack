...
const config: MesEntityConfig = {
  ...
  description: "Schedule batches against lines and machines",
  ...
  statusField: "status",
  statusOptions: ['planned', 'released', 'in_progress', 'completed'],
  columns: [
  ...
  fields: [
    { key: "order_number", label: "Code / Number", required: true, autoNumber: "BAT", createOnly: true },
    { key: "product_name", label: "Name / Title" },
    { key: "product_code", label: "Product code" },
    { key: "product_name", label: "Product name" },
    { key: "status", label: "Status", type: "select", options: ['planned', 'released', 'in_progress', 'completed'] },
