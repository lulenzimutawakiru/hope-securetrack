...
const config: MesEntityConfig = {
  ...
  numberPrefix: "LINE",
  searchCols: ["line_code", "name", "product_name", "product_code", "status", "title", "full_name"],
  statusField: "status",
  statusOptions: ['idle', 'running', 'maintenance', 'offline'],
  columns: [
    { key: "line_code", label: "Code / Number" },
  ...
  fields: [
    { key: "line_code", label: "Code / Number", required: true, autoNumber: "LINE", createOnly: true },
