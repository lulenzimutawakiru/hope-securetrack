...
export const CONTROL_PLANE_CAPABILITIES: ControlPlaneCapability[] = [
  ...
  { id: "security", layer: "platform", title: "Security Center", href: "/platform/security", description: "MFA, alerts, privileged access, SSO", roles: ["Security", "Platform Owner"] },
  ...
  { id: "support", layer: "platform", title: "Tenant Support", href: "/platform/support", description: "Tickets, controlled impersonation", roles: ["Platform Owner", "Support"] },
...
export const SUBSCRIPTION_PLANS: PlanEntitlements[] = [
  {
    plan_code: "starter",
    name: "Starter",
    description: "SME launch plan — core ERP with trial",
    max_users: 25,
    max_companies: 1,
    max_storage_gb: 10,
  ...
  },
  {
    ...
    name: "Government",
    description: "Public sector — residency, audit, high capacity",
    max_users: 10_000,
    max_companies: 200,
