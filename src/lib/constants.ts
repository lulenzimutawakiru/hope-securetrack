...
export const NAV_ITEMS = [
  ...
  { title: "Advanced Labels", href: "/dashboard/labels", icon: "Tag", permission: PERMISSIONS.LBL_VIEW },
  ...
  { title: "Print Ops", href: "/dashboard/print", icon: "Printer", permission: PERMISSIONS.PRINT_VIEW },
  { title: "Packing", href: "/dashboard/packing", icon: "Package", permission: PERMISSIONS.PACKING_CREATE },
  { title: "Packaging", href: "/dashboard/packaging", icon: "Boxes", permission: PERMISSIONS.PKG_VIEW },
  { title: "Assets", href: "/dashboard/assets", icon: "Tags", permission: PERMISSIONS.AST_VIEW },
  { title: "Inventory", href: "/dashboard/inventory", icon: "Warehouse", permission: PERMISSIONS.INVENTORY_VIEW },
  { title: "SRM / Procurement", href: "/dashboard/procurement", icon: "ShoppingBag", permission: PERMISSIONS.PROCUREMENT_VIEW },
  ...
  { title: "Fleet & Transport", href: "/dashboard/fleet", icon: "Car", permission: PERMISSIONS.FLEET_VIEW },
  ...
  { title: "HopeChat", href: "/dashboard/chat", icon: "MessageSquare", permission: PERMISSIONS.HC_VIEW },
  { title: "Service Desk", href: "/dashboard/service-desk", icon: "Headphones", permission: PERMISSIONS.SD_VIEW },
  { title: "ID Credentials", href: "/dashboard/credentials", icon: "IdCard", permission: PERMISSIONS.WID_VIEW },
  ...
  { title: "Workspaces", href: "/dashboard/workspaces", icon: "LayoutDashboard", permission: PERMISSIONS.DASHBOARD_VIEW },
  { title: "Boards", href: "/dashboard/boards", icon: "BarChart3", permission: PERMISSIONS.DASHBOARD_VIEW },
  { title: "Live Ops", href: "/dashboard/live", icon: "Activity", permission: PERMISSIONS.DASHBOARD_VIEW },
  { title: "Recycle Bin", href: "/dashboard/recycle-bin", icon: "ScrollText", permission: PERMISSIONS.SETTINGS_MANAGE },
  ...
  { title: "Integrations", href: "/dashboard/integrations", icon: "Plug", permission: PERMISSIONS.INTG_VIEW },
  { title: "Users", href: "/dashboard/users", icon: "Users", permission: PERMISSIONS.USERS_VIEW },
  { title: "Audit & Compliance", href: "/dashboard/audit", icon: "ScrollText", permission: PERMISSIONS.AUDIT_VIEW },
