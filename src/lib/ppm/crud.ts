...
export async function ppmAudit(input: {
  ...
  try {
    await sb().from("ppm_audit_log").insert({
...
export async function ppmCreate(
  table: string,
...
export async function ppmUpdate(
  table: string,
  id: string,
...
export async function ppmSoftDelete(table: string, id: string, actorId?: string | null) {
  const { data, error } = await sb()
    .from(table)
...
export async function ppmRestore(table: string, id: string, actorId?: string | null) {
  const { data, error } = await sb()
    .from(table)
...
export async function ppmDuplicate(
  table: string,
  id: string,
  ...
  return ppmCreate(table, { ...rest, ...overrides }, actorId);
}

export async function ppmBulkStatus(
  table: string,
  ids: string[],
  status: string,
  actorId?: string | null
...
export async function ppmNextNumber(
  table: string,
  companyId: string,
  prefix: string,
  _field = "code"
