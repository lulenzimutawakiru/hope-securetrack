...
function baseBack(extra: string): CardElement[] {
  return [
    ...
    },
    {
      ...
      w: 92,
      h: 8,
      text: "Official Credential — Hope Design Group Ltd",
      fontSize: 9,
      bold: true,
      z: 2,
    },
...
export function generateCardDesign(req: AiDesignRequest): AiDesignResult {
  ...
  > = {
    ...
    employee: {
      ...
      back: "Official employee ID. If found return to Hope Design Group, Kampala.",
